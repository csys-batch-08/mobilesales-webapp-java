					...
					<td>
						...
						<div class="container mt-3">
							...
							<button type="button" class="btn btn-dark" data-bs-toggle="modal"
								data-bs-target="#myModal_${serialNumber}">Activate</button>
						</div>
								...
								<div class="modal-content">
									...
									<div class="modal-body">
										<div>
											...
											<p>Do you want to Activate this
												user(${inactiveUserDetails.name }) ?</p>
											<a class="btn btn-success"
												href="activeUser?userId=${inactiveUserDetails.userId}">Confirm</a>
										</div>
									</div>
