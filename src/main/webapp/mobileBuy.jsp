		...
		<form action="buying" method="post">
			...
			<p>
				<label>Quantity :</label> <input type="number" id="myInput1"
					onkeyup="myFunction()" maxlength="2" min="1" value=1 pattern="[1-9]{1+}"><br>
				<br>
			</p>
			<p>
				<label> Price :</label> <input type="number" id="myInput2"
					maxlength="2" readonly value="${sessionScope.price}" pattern="[1-9]+{1+}"><br>
				<br>
			</p>
			...
			<p>
				<button style="margin-left: 150px" class="btn btn-success btn-lg"
